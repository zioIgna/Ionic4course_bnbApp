...
export class PlacesService {
      ...
      switchMap(token => {
        return this.http
          .get<{ [key: string]: PlaceData }>(
            `https://ionic-angular-course-fb3d1.firebaseio.com/offered-places.json?auth=${token}`
          )
      }),
      map(
        resData => {
  ...
  getPlace(id: string) {
    return this.authService.token.pipe(
      ...
      switchMap(token => {
        return this.http
          .get<PlaceData>(`https://ionic-angular-course-fb3d1.firebaseio.com/offered-places/${id}.json?auth=${token}`)
      }),
      map(placeData => {
        return new Place(
          id,
    ...
    return this.authService.token.pipe(
      ...
      switchMap(places => {
        ...
        return this.http.put(
          `https://ionic-angular-course-fb3d1.firebaseio.com/offered-places/${placeId}.json?auth=${fetchedToken}`,
